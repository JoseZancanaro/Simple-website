const Title = () => {
  return (
    <h1 className='pt-8 text-4xl font-mono font-semibold text-center text-slate-800 dark:text-stone-200'>
  ...
  return (
    <div className='grid grid-cols-3'>
      <p className='col-start-2 indent-10 text-justify text-lg font-mono font-medium text-slate-900 dark:text-stone-300'>
        ...
        With great interest in <span className='font-semibold dark:font-extrabold'>learning more</span>, i seek new opportunities in the various areas of Computer Science.
      </p>
    </div>
  )
}
